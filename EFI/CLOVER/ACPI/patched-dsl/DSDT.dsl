 ...
 *
 * Disassembly of DSDT.aml, Fri Jan 31 21:41:46 2020
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, 0x01)
    Name (SS4, 0x01)
    OperationRegion (GNVS, SystemMemory, 0xBFF58000, 0x072C)
    ...
    OperationRegion (MNVS, SystemMemory, 0xBFF68018, 0x1000)
            ...
            If (LAnd (\WNTF, \TATC))
            {
                Switch (ToInteger (And (Local0, 0x01FF)))
                {
                    ...
                    Case (0x05)
                    {
                        ...
                        {
                            Store (ShiftLeft (0x06, 0x08), Local1)
